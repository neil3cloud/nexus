...
- `kernel/` documents the kernel services and provider-facing contracts.
...
Repository structure should mirror stable runtime concepts. Avoid introducing folders that imply autonomous systems, knowledge graph platforms, or provider-owned architecture.
